...
DOCS = {
    "lso-runbook":    ("1.0", "2026-07-27", "LSO Runbook — Imperial Knights",
                       "Battle-shock rules + Code Chivalric integrated; clean-DB verified.",
                       "docs/reports/knights/LSO-Runbook.docx"),
    "lso-analysis":   ("1.0", "2026-07-27", "LSO Knights — List & Analysis",
                       "26 matchups; List A locked at 1,970.",
                       "docs/reports/knights/LSO-Knights-List-and-Analysis.xlsx"),
    "lso-decision":   ("1.0", "2026-07-27", "LSO Knights — List Decision",
                       "List A vs B, prevalence-weighted.",
                       "docs/reports/knights/LSO-Knights-List-Decision.xlsx"),
    "gv-runbook":     ("1.0", "2026-07-27", "Great Value — LSO Runbook",
                       "Battle-shock weakness + Librarius disciplines corrected.",
                       "docs/reports/great-value/GV-LSO-Runbook.docx"),
    "gv-analysis":    ("1.0", "2026-07-27", "Great Value — LSO Analysis",
                       "10 matchups, GV perspective.",
                       "docs/reports/great-value/GV-LSO-Analysis.xlsx"),
    "gv-sim":         ("1.0", "2026-07-27", "Great Value vs Knights — Full-Game Simulation",
                       "Hardened sim, ~60/40 Knights.",
