...
BASE = {
    "fe9-OtodOI0": ("questoris-companions", "Questoris Companions", "take-and-hold", 3),
    "hHnOA50c09I": ("gate-warden-lance",   "Gate Warden Lance",    "take-and-hold", 2),
    "FGVx0OgDRDY": ("valourstrike-lance",   "Valourstrike Lance",   "purge-the-foe", 2),
    "YC0HBiOAS1A": ("spearhead-at-arms",    "Spearhead-at-Arms",    "reconnaissance", 2),
}
...
with open('base_detachments.yaml', 'w', encoding='utf-8') as fh:
    yaml.dump(detachments, fh, allow_unicode=True, sort_keys=False, width=100,
              default_flow_style=False)
print("\nwrote base_detachments.yaml")
