...
MATCHUPS = [
    ...
    dict(key="great-value-imperial-fists", faction="Imperial Fists", archetype="'Great Value' — Emperor's Shield + Librarius Conclave (the LSO target)",
         ...
         deciding="Unsaveable Sternguard Dev (full wound-reroll vs Oath) + sticky OC10 Intercessors + an OC34 Lysander Terminator brick (NOT battle-shock-immune, but Knights have no way to force a test) + Armour of Contempt + a ~30-34 Oath-convergence alpha. Sisters 98-31 lesson: durable + sticky + volume.",
         heist=["Navigator dome (12\" anti-Deep-Strike) blunts his Teleport-Homer / Land-Speeder deep-strike alpha.",
                ...
                "Out-mobile the M5 bricks — his OC34 brick can't be everywhere; contest the objectives it isn't on with OC10 + the Lancer threatening his home.",
