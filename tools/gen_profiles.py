...
cat = json.load(open('ik_lib.json'))['catalogue']
...
CORE_RULES = {'Deadly Demise', 'Lone Operative'}
FACTION_RULES = {'Code Chivalric', 'Super-Heavy Walker'}
...
mfm = {d['name']: d['points_first']
       for d in yaml.safe_load(open('/opt/projects/wh/data/datasheets/imperial-knights.yaml'))}
