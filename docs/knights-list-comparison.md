# Knights list comparison — my slate vs two tournament examples
...
- **EX1 Big-Five** — five ~T11-13/26-28W Knights, no Armigers. Strong everywhere on the stat-check
  (good anti-horde, huge anti-tank, super-durable individually) and a Cerastus Castigator melee threat.
